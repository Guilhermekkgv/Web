...
local buttonClickedState = false

CancelButton.MouseEnter:Connect(function()
    if not buttonClickedState then
        TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 120, 190)}):Play()
    end
end)
...
CancelButton.MouseButton1Click:Connect(function()
    buttonClickedState = not buttonClickedState
    if buttonClickedState then
        TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 140, 200)}):Play()
    else
        TweenService:Create(CancelButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 105, 180)}):Play()
    end
...
ConfirmButton.MouseEnter:Connect(function()
    if not buttonClickedState then
        TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 120, 190)}):Play()
    end
end)
...
ConfirmButton.MouseButton1Click:Connect(function()
    buttonClickedState = not buttonClickedState
    if buttonClickedState then
        TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 140, 200)}):Play()
    else
        TweenService:Create(ConfirmButton, TweenInfo.new(0.2), {BackgroundColor3 = Color3.fromRGB(255, 105, 180)}):Play()
    end
    LinuxUI:Destroy()
...
function LinuxLib.Tab(config)
    ...
    local textOffset = config.Icon and config.Enabled and 30 or 14
    local TabText = Linux.Instance("TextLabel", {
        Parent = TabBtn,
        BackgroundTransparency = 1,
        Size = UDim2.new(1, -(textOffset + 16), 1, 0),
    ...
    TabBtn.MouseLeave:Connect(function()
        if CurrentTab ~= tabIndex then
            TweenService:Create(TabText, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(150, 150, 150)}):Play()
            if TabIcon then
                TweenService:Create(TabIcon, TweenInfo.new(0.2), {ImageColor3 = Color3.fromRGB(150, 150, 150)}):Play()
            end
        end
    end)
    ...
    local function SelectTab()
        ...
        TabBtn.BorderColor3 = Color3.fromRGB(60, 60, 70)
    ...
    function TabElements.Toggle(config)
        ...
        Toggle.MouseEnter:Connect(function()
            TweenService:Create(ToggleText, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        Toggle.MouseLeave:Connect(function()
            TweenService:Create(ToggleText, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
        ...
        local function UpdateToggle(thisToggle)
            ...
            if thisTrack and thisKnob then
                ...
                if currentState then
                    ...
                    TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 20, 0.5, -6), BackgroundColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                else
                    TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(17, 17, 18)}):Play()
                    TweenService:Create(thisKnob, tween, {Position = UDim2.new(0, 2, 0.5, -6), BackgroundColor3 = Color3.fromRGB(200, 200, 210)}):Play()
                end
            end
    ...
    function TabElements.Dropdown(config)
        ...
        Dropdown.MouseEnter:Connect(function()
            TweenService:Create(DropdownLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        Dropdown.MouseLeave:Connect(function()
            TweenService:Create(DropdownLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
        ...
        local function FormatDisplayText(value)
            if typeof(value) == "table" then
                if #value > 0 then
                    ...
                    return displayText:sub(1, 18) .. (#displayText > 18 and "..." or "")
                else
                    return "None"
                end
            else
        ...
        local function UpdateDropSize()
            ...
            if IsOpen then
                ...
                DropFrame.Size = UDim2.new(1, -6, 0, 0)
    ...
    function TabElements.Slider(config)
        ...
        Slider.MouseLeave:Connect(function()
            TweenService:Create(TitleLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
        ...
        local function AnimateValueLabel()
            local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
            TweenService:Create(ValueLabel, tweenInfo, {TextSize = 15}):Play()
            task.wait(0.2)
            TweenService:Create(ValueLabel, tweenInfo, {TextSize = 13}):Play()
        end
    ...
    function TabElements.Input(config)
        ...
        Input.MouseEnter:Connect(function()
            TweenService:Create(InputLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        Input.MouseLeave:Connect(function()
            TweenService:Create(InputLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
        ...
        local TextBox = Linux.Instance("TextBox", {
            ...
            BorderSizePixel = 0,
            Size = UDim2.new(0.3, -14, 0, 22),
            Position = UDim2.new(0.7, -18, 0.5, -11),
            Font = Enum.Font.GothamSemibold,
    ...
    function TabElements.Label(config)
        ...
        LabelFrame.MouseEnter:Connect(function()
            TweenService:Create(LabelText, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        LabelFrame.MouseLeave:Connect(function()
            TweenService:Create(LabelText, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
    ...
    function TabElements.Paragraph(config)
        ...
        ParagraphFrame.MouseEnter:Connect(function()
            TweenService:Create(ParagraphTitle, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        ParagraphFrame.MouseLeave:Connect(function()
            TweenService:Create(ParagraphTitle, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
    ...
    function TabElements.Notification(config)
        ...
        local NotificationLabel = Linux.Instance("TextLabel", {
            Parent = NotificationFrame,
            BackgroundTransparency = 1,
        ...
        NotificationFrame.MouseEnter:Connect(function()
            TweenService:Create(NotificationLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        NotificationFrame.MouseLeave:Connect(function()
            TweenService:Create(NotificationLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
    ...
    function TabElements.Keybind(config)
        ...
        local KeybindLabel = Linux.Instance("TextLabel", {
            Parent = KeybindFrame,
            BackgroundTransparency = 1,
            Size = UDim2.new(0.6, 0, 1, 0),
            Position = UDim2.new(0, 9, 0, 0),
        ...
        KeybindFrame.MouseEnter:Connect(function()
            TweenService:Create(KeybindLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        KeybindFrame.MouseLeave:Connect(function()
            TweenService:Create(KeybindLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
        ...
        local KeybindButton = Linux.Instance("TextButton", {
            ...
            BorderSizePixel = 0,
            Size = UDim2.new(0.3, -14, 0, 22),
            Position = UDim2.new(0.7, 0, 0.5, -11),
            Font = Enum.Font.GothamSemibold,
    ...
    function TabElements.Colorpicker(config)
        ...
        local ColorpickerLabel = Linux.Instance("TextLabel", {
            Parent = ColorpickerFrame,
            BackgroundTransparency = 1,
            Size = UDim2.new(0.6, 0, 1, 0),
            Position = UDim2.new(0, 9, 0, 0),
        ...
        ColorpickerFrame.MouseEnter:Connect(function()
            TweenService:Create(ColorpickerLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        
        ColorpickerFrame.MouseLeave:Connect(function()
            TweenService:Create(ColorpickerLabel, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
        end)
        ...
        local function CreateColorpickerPopup()
            ...
            ColorpickerPopup = Linux.Instance("Frame", {
                ...
                Position = UDim2.new(0.5, -95, 0.5, -85),
                ZIndex = 10,
                Visible = false,
                BackgroundTransparency = 1
            })
            ...
            local ColorPreview = Linux.Instance("Frame", {
                Parent = ColorpickerPopup,
                BackgroundColor3 = currentColor,
                Size = UDim2.new(0, 167, 0, 28),
                Position = UDim2.new(0, 9, 0, 130),
                ZIndex = 11,
                BorderSizePixel = 0,
                BorderColor3 = Color3.fromRGB(39, 39, 42),
                Name = "ColorPreview"
            ...
            HueBar.InputBegan:Connect(function(input)
                if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                    ...
                    local hue Size = HueBar.AbsoluteSize
        ...
        ColorPreview.InputBegan:Connect(function(input)
            if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
                ...
                if isPicking then
                    ...
                    TweenService:Create(ColorpickerPopup, fadeIn, {BackgroundTransparency = 0}):Play()
                else
                    if ColorpickerPopup then
                        local fadeOut = TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.In)
                        TweenService:Create(ColorpickerPopup, fadeOut, {BackgroundTransparency = 1}):Play()
                        task.wait(0.3)
